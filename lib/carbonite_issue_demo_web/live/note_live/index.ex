defmodule CarboniteIssueDemoWeb.NoteLive.Index do
  use CarboniteIssueDemoWeb, :live_view
  ...
  @impl true
  def handle_info({CarboniteIssueDemoWeb.NoteLive.FormComponent, {:saved, note}}, socket) do
